...
static int match_keyboard(char *dev_name)
{
	...
	cond1 = strncmp(&dev_name[strlen(dev_name) - 9], "keyboard", 8);
	cond2 = strncmp(&dev_name[strlen(dev_name) - 9], "Keyboard", 8);
	cond3 = strncmp(&dev_name[strlen(dev_name) - 9], "KeyBoard", 8);
