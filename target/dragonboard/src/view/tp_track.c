...
#if defined(_CONFIG_TOUCHSCREEN_TESTCASE)
...
#if defined(_SUN8IW6P1) || defined(_SUN50IW1P1) || defined(_SUN8IW11P1)
static disp_layer_config layer_config;
#elif defined(_SUN8IW5P1) || defined(_SUN9IW1P1)
